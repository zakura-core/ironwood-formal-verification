import Zcash.Snark.ZeroKnowledge.ActionGateSourceChunks.Chunk010
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionGateSourceChunk010.remaining) := by

import Zcash.Snark.ZeroKnowledge.ActionGateSourceChunks.Chunk019
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionGateSourceChunk019.remaining) := by

import Zcash.Snark.ZeroKnowledge.ActionGateSourceChunks.Chunk017
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionGateSourceChunk017.remaining) := by

import Zcash.Snark.ZeroKnowledge.ActionGateSourceChunks.Chunk013
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionGateSourceChunk013.remaining) := by

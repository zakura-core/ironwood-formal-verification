import Zcash.Snark.ZeroKnowledge.ActionGateSourceChunks.Chunk009
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionGateSourceChunk009.remaining) := by

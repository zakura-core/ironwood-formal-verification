import Zcash.Snark.ZeroKnowledge.ActionGateSourceChunks.Chunk011
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionGateSourceChunk011.remaining) := by

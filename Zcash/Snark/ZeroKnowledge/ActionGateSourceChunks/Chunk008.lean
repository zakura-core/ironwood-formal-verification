import Zcash.Snark.ZeroKnowledge.ActionGateSourceChunks.Chunk007
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionGateSourceChunk007.remaining) := by

import Zcash.Snark.ZeroKnowledge.ActionGateSourceChunks.Chunk016
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionGateSourceChunk016.remaining) := by

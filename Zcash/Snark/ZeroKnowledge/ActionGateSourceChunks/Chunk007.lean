import Zcash.Snark.ZeroKnowledge.ActionGateSourceChunks.Chunk006
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionGateSourceChunk006.remaining) := by

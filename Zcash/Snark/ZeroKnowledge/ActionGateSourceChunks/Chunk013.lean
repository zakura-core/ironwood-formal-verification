import Zcash.Snark.ZeroKnowledge.ActionGateSourceChunks.Chunk012
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionGateSourceChunk012.remaining) := by

import Zcash.Snark.ZeroKnowledge.ActionGateSourceChunks.Chunk003
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionGateSourceChunk003.remaining) := by

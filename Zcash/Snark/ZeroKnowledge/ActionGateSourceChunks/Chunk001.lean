import Zcash.Snark.ZeroKnowledge.ActionGateSourceChunks.Chunk000
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionGateSourceChunk000.remaining) := by

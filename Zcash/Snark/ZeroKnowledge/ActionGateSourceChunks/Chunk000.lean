import Zcash.Snark.ZeroKnowledge.ActionGateSourcePrefix
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionGateSourcePrefix.remaining) := by

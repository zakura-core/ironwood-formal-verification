...
function. Divisibility and capacity of the numerator on reachable row states remain explicit
premises. The honest row algorithms and the full verifier's grouping still require integration.

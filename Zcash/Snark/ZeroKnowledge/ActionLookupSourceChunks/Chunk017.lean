import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk016
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk016.remaining) := by

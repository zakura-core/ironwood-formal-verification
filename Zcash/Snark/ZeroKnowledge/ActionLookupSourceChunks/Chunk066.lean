import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk065
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk065.remaining) := by

import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk022
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk022.remaining) := by

import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk013
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk013.remaining) := by

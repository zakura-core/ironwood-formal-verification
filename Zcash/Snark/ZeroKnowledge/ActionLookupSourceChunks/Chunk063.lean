import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk062
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk062.remaining) := by

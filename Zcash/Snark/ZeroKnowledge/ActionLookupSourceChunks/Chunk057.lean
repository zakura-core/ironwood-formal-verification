import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk056
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk056.remaining) := by

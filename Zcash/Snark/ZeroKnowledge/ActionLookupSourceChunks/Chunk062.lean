import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk061
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk061.remaining) := by

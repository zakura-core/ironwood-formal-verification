import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk011
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk011.remaining) := by

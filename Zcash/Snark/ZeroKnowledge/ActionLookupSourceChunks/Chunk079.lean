import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk078
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk078.remaining) := by

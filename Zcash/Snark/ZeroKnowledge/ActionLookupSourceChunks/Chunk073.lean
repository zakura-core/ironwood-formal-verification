import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk072
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk072.remaining) := by

import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk034
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk034.remaining) := by

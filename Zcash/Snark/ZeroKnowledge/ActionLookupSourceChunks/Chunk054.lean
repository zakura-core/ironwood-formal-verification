import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk053
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk053.remaining) := by

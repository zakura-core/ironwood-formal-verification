import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk050
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk050.remaining) := by

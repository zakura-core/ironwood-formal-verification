import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk002
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk002.remaining) := by

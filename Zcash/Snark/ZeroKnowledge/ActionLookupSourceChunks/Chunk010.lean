import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk009
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk009.remaining) := by

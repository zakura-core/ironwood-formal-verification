import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk018
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk018.remaining) := by

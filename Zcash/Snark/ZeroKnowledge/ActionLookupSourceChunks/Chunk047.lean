import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk046
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk046.remaining) := by

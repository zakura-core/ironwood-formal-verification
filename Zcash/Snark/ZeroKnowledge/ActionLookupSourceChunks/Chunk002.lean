import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk001
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk001.remaining) := by

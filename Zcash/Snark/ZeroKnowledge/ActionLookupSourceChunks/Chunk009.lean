import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk008
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk008.remaining) := by

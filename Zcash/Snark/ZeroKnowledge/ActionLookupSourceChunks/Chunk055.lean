import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk054
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk054.remaining) := by

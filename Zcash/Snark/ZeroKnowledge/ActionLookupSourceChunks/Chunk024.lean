import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk023
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk023.remaining) := by

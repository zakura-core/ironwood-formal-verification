import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk076
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk076.remaining) := by

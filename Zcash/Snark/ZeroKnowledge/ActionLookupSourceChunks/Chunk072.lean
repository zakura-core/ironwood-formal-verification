import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk071
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk071.remaining) := by

import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk014
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk014.remaining) := by

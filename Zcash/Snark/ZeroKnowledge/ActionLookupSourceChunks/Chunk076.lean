import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk075
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk075.remaining) := by

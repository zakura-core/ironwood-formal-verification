import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk017
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk017.remaining) := by

import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk049
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk049.remaining) := by
  certify_source_list_piece 8 64

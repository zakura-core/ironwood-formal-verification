import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk015
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk015.remaining) := by

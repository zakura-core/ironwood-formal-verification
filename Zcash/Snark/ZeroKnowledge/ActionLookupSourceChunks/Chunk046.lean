import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk045
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk045.remaining) := by

import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk025
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk025.remaining) := by

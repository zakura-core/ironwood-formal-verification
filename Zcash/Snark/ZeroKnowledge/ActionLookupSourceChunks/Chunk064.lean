import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk063
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk063.remaining) := by

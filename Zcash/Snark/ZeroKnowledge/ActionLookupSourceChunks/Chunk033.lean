import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk032
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk032.remaining) := by

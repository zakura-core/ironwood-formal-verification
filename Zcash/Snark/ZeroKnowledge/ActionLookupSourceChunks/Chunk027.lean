import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk026
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk026.remaining) := by

import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk003
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk003.remaining) := by

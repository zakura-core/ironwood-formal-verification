import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk048
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk048.remaining) := by

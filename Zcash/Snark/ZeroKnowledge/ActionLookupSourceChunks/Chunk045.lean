import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk044
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk044.remaining) := by

import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk051
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk051.remaining) := by

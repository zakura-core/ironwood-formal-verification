import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk069
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk069.remaining) := by

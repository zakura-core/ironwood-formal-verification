import Zcash.Snark.ZeroKnowledge.ActionLookupSourceLabels

/-!
# Bounded continuation of the original lookup source

The module starts from the original lookup source and composes checked
continuations for it. The remaining suffix is still an explicit
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceLabels) := by
...
noncomputable def actionLookupSourceChunk000 :

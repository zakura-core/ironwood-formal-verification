import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk070
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk070.remaining) := by

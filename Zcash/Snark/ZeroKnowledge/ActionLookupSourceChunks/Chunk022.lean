import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk021
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk021.remaining) := by

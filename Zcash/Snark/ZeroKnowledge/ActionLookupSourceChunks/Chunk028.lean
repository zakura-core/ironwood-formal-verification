import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk027
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk027.remaining) := by

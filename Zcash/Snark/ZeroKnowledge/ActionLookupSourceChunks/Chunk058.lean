import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk057
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk057.remaining) := by

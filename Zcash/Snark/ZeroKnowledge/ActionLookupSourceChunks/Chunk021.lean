import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk020
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk020.remaining) := by

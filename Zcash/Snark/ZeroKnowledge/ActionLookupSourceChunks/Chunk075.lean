import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk074
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk074.remaining) := by

import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk039
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk039.remaining) := by

import Zcash.Snark.ZeroKnowledge.ActionLookupSourceChunks.Chunk066
...
private noncomputable def piece000 :
    SourceCertificatePiece SourceListCertificate (actionLookupSourceChunk066.remaining) := by

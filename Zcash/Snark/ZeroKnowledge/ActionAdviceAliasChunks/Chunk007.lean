import Zcash.Snark.ZeroKnowledge.ActionAdviceAliasChunks.Chunk006
...
private noncomputable def piece000 :
    AdviceMapScanPiece adviceAliasMapStep actionAdviceAliasChunk006.remainingRoots
      actionAdviceAliasChunk006.remainingEntries := by
...
noncomputable def actionAdviceAliasChunk007 :
  ...
  finish suffix :=
    actionAdviceAliasChunk006.finish <|
    piece000.finish <|
    piece001.finish <|
    piece002.finish <|
    piece003.finish <|

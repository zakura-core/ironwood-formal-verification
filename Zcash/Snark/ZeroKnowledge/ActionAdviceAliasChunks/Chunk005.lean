import Zcash.Snark.ZeroKnowledge.ActionAdviceAliasChunks.Chunk004
...
private noncomputable def piece000 :
    AdviceMapScanPiece adviceAliasMapStep actionAdviceAliasChunk004.remainingRoots
      actionAdviceAliasChunk004.remainingEntries := by
...
noncomputable def actionAdviceAliasChunk005 :
  ...
  finish suffix :=
    actionAdviceAliasChunk004.finish <|
    piece000.finish <|
    piece001.finish <|
    piece002.finish <|
    piece003.finish <|

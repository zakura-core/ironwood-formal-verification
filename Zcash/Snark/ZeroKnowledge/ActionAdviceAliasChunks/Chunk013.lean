import Zcash.Snark.ZeroKnowledge.ActionAdviceAliasChunks.Chunk012
...
private noncomputable def piece000 :
    AdviceMapScanPiece adviceAliasMapStep actionAdviceAliasChunk012.remainingRoots
      actionAdviceAliasChunk012.remainingEntries := by
...
noncomputable def actionAdviceAliasChunk013 :
  ...
  finish suffix :=
    actionAdviceAliasChunk012.finish <|
    piece000.finish <|
    piece001.finish <|
    piece002.finish <|
    piece003.finish <|

import Zcash.Snark.ZeroKnowledge.ActionAdviceAliasChunks.Chunk002
...
private noncomputable def piece000 :
    AdviceMapScanPiece adviceAliasMapStep actionAdviceAliasChunk002.remainingRoots
      actionAdviceAliasChunk002.remainingEntries := by
...
noncomputable def actionAdviceAliasChunk003 :
  ...
  finish suffix :=
    actionAdviceAliasChunk002.finish <|
    piece000.finish <|
    piece001.finish <|
    piece002.finish <|
    piece003.finish <|

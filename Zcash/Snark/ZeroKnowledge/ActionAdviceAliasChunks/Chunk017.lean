import Zcash.Snark.ZeroKnowledge.ActionAdviceAliasChunks.Chunk016
...
private noncomputable def piece000 :
    AdviceMapScanPiece adviceAliasMapStep actionAdviceAliasChunk016.remainingRoots
      actionAdviceAliasChunk016.remainingEntries := by
...
noncomputable def actionAdviceAliasChunk017 :
  ...
  finish suffix :=
    actionAdviceAliasChunk016.finish <|
    piece000.finish <|
    piece001.finish <|
    piece002.finish <|
    piece003.finish <|

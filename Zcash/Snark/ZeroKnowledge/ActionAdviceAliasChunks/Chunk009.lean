import Zcash.Snark.ZeroKnowledge.ActionAdviceAliasChunks.Chunk008
...
private noncomputable def piece000 :
    AdviceMapScanPiece adviceAliasMapStep actionAdviceAliasChunk008.remainingRoots
      actionAdviceAliasChunk008.remainingEntries := by
...
noncomputable def actionAdviceAliasChunk009 :
  ...
  finish suffix :=
    actionAdviceAliasChunk008.finish <|
    piece000.finish <|
    piece001.finish <|
    piece002.finish <|
    piece003.finish <|

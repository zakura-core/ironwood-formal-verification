import Zcash.Snark.ZeroKnowledge.ActionAdviceAliasChunks.Chunk000
...
private noncomputable def piece000 :
    AdviceMapScanPiece adviceAliasMapStep actionAdviceAliasChunk000.remainingRoots
      actionAdviceAliasChunk000.remainingEntries := by
...
noncomputable def actionAdviceAliasChunk001 :
  ...
  finish suffix :=
    actionAdviceAliasChunk000.finish <|
    piece000.finish <|
    piece001.finish <|
    piece002.finish <|
    piece003.finish <|

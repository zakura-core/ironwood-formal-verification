import Zcash.Snark.ZeroKnowledge.ActionAdviceAliasChunks.Chunk015
...
private noncomputable def piece000 :
    AdviceMapScanPiece adviceAliasMapStep actionAdviceAliasChunk015.remainingRoots
      actionAdviceAliasChunk015.remainingEntries := by
...
noncomputable def actionAdviceAliasChunk016 :
  ...
  finish suffix :=
    actionAdviceAliasChunk015.finish <|
    piece000.finish <|
    piece001.finish <|
    piece002.finish <|
    piece003.finish <|

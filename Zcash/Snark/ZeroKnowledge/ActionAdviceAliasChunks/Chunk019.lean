import Zcash.Snark.ZeroKnowledge.ActionAdviceAliasChunks.Chunk018
...
private noncomputable def piece000 :
    AdviceMapScanPiece adviceAliasMapStep actionAdviceAliasChunk018.remainingRoots
      actionAdviceAliasChunk018.remainingEntries := by
...
noncomputable def actionAdviceAliasChunk019 :
  ...
  finish suffix :=
    actionAdviceAliasChunk018.finish <|
    piece000.finish <|
    piece001.finish <|
    piece002.finish <|
    piece003.finish <|

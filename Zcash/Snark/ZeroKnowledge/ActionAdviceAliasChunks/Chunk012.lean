import Zcash.Snark.ZeroKnowledge.ActionAdviceAliasChunks.Chunk011
...
private noncomputable def piece000 :
    AdviceMapScanPiece adviceAliasMapStep actionAdviceAliasChunk011.remainingRoots
      actionAdviceAliasChunk011.remainingEntries := by
...
noncomputable def actionAdviceAliasChunk012 :
  ...
  finish suffix :=
    actionAdviceAliasChunk011.finish <|
    piece000.finish <|
    piece001.finish <|
    piece002.finish <|
    piece003.finish <|

import Zcash.Snark.ZeroKnowledge.ActionAdviceAliasChunks.Chunk003
...
private noncomputable def piece000 :
    AdviceMapScanPiece adviceAliasMapStep actionAdviceAliasChunk003.remainingRoots
      actionAdviceAliasChunk003.remainingEntries := by
...
noncomputable def actionAdviceAliasChunk004 :
  ...
  finish suffix :=
    actionAdviceAliasChunk003.finish <|
    piece000.finish <|
    piece001.finish <|
    piece002.finish <|
    piece003.finish <|

import Zcash.Snark.ZeroKnowledge.ActionAdviceAliasChunks.Chunk013
...
private noncomputable def piece000 :
    AdviceMapScanPiece adviceAliasMapStep actionAdviceAliasChunk013.remainingRoots
      actionAdviceAliasChunk013.remainingEntries := by
...
noncomputable def actionAdviceAliasChunk014 :
  ...
  finish suffix :=
    actionAdviceAliasChunk013.finish <|
    piece000.finish <|
    piece001.finish <|
    piece002.finish <|
    piece003.finish <|

import Zcash.Snark.ZeroKnowledge.ActionAdviceAliasChunks.Chunk014
...
private noncomputable def piece000 :
    AdviceMapScanPiece adviceAliasMapStep actionAdviceAliasChunk014.remainingRoots
      actionAdviceAliasChunk014.remainingEntries := by
...
noncomputable def actionAdviceAliasChunk015 :
  ...
  finish suffix :=
    actionAdviceAliasChunk014.finish <|
    piece000.finish <|
    piece001.finish <|
    piece002.finish <|
    piece003.finish <|

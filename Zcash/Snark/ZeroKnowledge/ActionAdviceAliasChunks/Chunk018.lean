import Zcash.Snark.ZeroKnowledge.ActionAdviceAliasChunks.Chunk017
...
private noncomputable def piece000 :
    AdviceMapScanPiece adviceAliasMapStep actionAdviceAliasChunk017.remainingRoots
      actionAdviceAliasChunk017.remainingEntries := by
...
noncomputable def actionAdviceAliasChunk018 :
  ...
  finish suffix :=
    actionAdviceAliasChunk017.finish <|
    piece000.finish <|
    piece001.finish <|
    piece002.finish <|
    piece003.finish <|

import Zcash.Snark.ZeroKnowledge.ActionAdviceAliasChunks.Chunk007
...
private noncomputable def piece000 :
    AdviceMapScanPiece adviceAliasMapStep actionAdviceAliasChunk007.remainingRoots
      actionAdviceAliasChunk007.remainingEntries := by
...
noncomputable def actionAdviceAliasChunk008 :
  ...
  finish suffix :=
    actionAdviceAliasChunk007.finish <|
    piece000.finish <|
    piece001.finish <|
    piece002.finish <|
    piece003.finish <|

import Zcash.Snark.ZeroKnowledge.ActionAdviceAliasChunks.Chunk001
...
private noncomputable def piece000 :
    AdviceMapScanPiece adviceAliasMapStep actionAdviceAliasChunk001.remainingRoots
      actionAdviceAliasChunk001.remainingEntries := by
...
noncomputable def actionAdviceAliasChunk002 :
  ...
  finish suffix :=
    actionAdviceAliasChunk001.finish <|
    piece000.finish <|
    piece001.finish <|
    piece002.finish <|
    piece003.finish <|

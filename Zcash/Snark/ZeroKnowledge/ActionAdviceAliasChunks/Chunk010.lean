import Zcash.Snark.ZeroKnowledge.ActionAdviceAliasChunks.Chunk009
...
private noncomputable def piece000 :
    AdviceMapScanPiece adviceAliasMapStep actionAdviceAliasChunk009.remainingRoots
      actionAdviceAliasChunk009.remainingEntries := by
...
noncomputable def actionAdviceAliasChunk010 :
  ...
  finish suffix :=
    actionAdviceAliasChunk009.finish <|
    piece000.finish <|
    piece001.finish <|
    piece002.finish <|
    piece003.finish <|

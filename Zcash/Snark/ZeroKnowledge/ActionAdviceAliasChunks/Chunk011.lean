import Zcash.Snark.ZeroKnowledge.ActionAdviceAliasChunks.Chunk010
...
private noncomputable def piece000 :
    AdviceMapScanPiece adviceAliasMapStep actionAdviceAliasChunk010.remainingRoots
      actionAdviceAliasChunk010.remainingEntries := by
...
noncomputable def actionAdviceAliasChunk011 :
  ...
  finish suffix :=
    actionAdviceAliasChunk010.finish <|
    piece000.finish <|
    piece001.finish <|
    piece002.finish <|
    piece003.finish <|

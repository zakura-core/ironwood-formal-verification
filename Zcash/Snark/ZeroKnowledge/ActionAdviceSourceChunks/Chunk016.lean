import Zcash.Snark.ZeroKnowledge.ActionAdviceSourceChunks.Chunk015
...
private noncomputable def piece000 :
    SourceCertificatePiece (AdviceSourceCertificate (F := Fp)) (actionAdviceSourceChunk015.remaining) := by

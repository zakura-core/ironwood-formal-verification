import Zcash.Snark.ZeroKnowledge.ActionAdviceSourceChunks.Chunk009
...
private noncomputable def piece000 :
    SourceCertificatePiece (AdviceSourceCertificate (F := Fp)) (actionAdviceSourceChunk009.remaining) := by

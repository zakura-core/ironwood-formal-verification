import Zcash.Snark.ZeroKnowledge.ActionAdviceSourceChunks.Chunk000
...
private noncomputable def piece000 :
    SourceCertificatePiece (AdviceSourceCertificate (F := Fp)) (actionAdviceSourceChunk000.remaining) := by

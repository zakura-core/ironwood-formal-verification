import Zcash.Snark.ZeroKnowledge.ActionAdviceSourceChunks.Chunk016
...
private noncomputable def piece000 :
    SourceCertificatePiece (AdviceSourceCertificate (F := Fp)) (actionAdviceSourceChunk016.remaining) := by

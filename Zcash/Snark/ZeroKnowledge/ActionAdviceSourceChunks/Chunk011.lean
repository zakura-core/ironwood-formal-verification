import Zcash.Snark.ZeroKnowledge.ActionAdviceSourceChunks.Chunk010
...
private noncomputable def piece000 :
    SourceCertificatePiece (AdviceSourceCertificate (F := Fp)) (actionAdviceSourceChunk010.remaining) := by

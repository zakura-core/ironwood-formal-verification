import Zcash.Snark.ZeroKnowledge.ActionAdviceSourceChunks.Chunk019
...
private noncomputable def piece000 :
    SourceCertificatePiece (AdviceSourceCertificate (F := Fp)) (actionAdviceSourceChunk019.remaining) := by

import Zcash.Snark.ZeroKnowledge.ActionAdviceSourceChunks.Chunk008
...
private noncomputable def piece000 :
    SourceCertificatePiece (AdviceSourceCertificate (F := Fp)) (actionAdviceSourceChunk008.remaining) := by

import Zcash.Snark.ZeroKnowledge.ActionAdviceSourceChunks.Chunk024
...
private noncomputable def piece000 :
    SourceCertificatePiece (AdviceSourceCertificate (F := Fp)) (actionAdviceSourceChunk024.remaining) := by

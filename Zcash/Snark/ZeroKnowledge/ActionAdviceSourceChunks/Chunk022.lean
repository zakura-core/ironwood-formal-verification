import Zcash.Snark.ZeroKnowledge.ActionAdviceSourceChunks.Chunk021
...
private noncomputable def piece000 :
    SourceCertificatePiece (AdviceSourceCertificate (F := Fp)) (actionAdviceSourceChunk021.remaining) := by

import Zcash.Snark.ZeroKnowledge.ActionAdviceSourceChunks.Chunk018
...
private noncomputable def piece000 :
    SourceCertificatePiece (AdviceSourceCertificate (F := Fp)) (actionAdviceSourceChunk018.remaining) := by

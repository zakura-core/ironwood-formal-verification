import Zcash.Snark.ZeroKnowledge.ActionAdviceSourceChunks.Chunk002
...
private noncomputable def piece000 :
    SourceCertificatePiece (AdviceSourceCertificate (F := Fp)) (actionAdviceSourceChunk002.remaining) := by

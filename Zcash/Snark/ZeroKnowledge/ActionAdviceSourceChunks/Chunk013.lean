import Zcash.Snark.ZeroKnowledge.ActionAdviceSourceChunks.Chunk012
...
private noncomputable def piece000 :
    SourceCertificatePiece (AdviceSourceCertificate (F := Fp)) (actionAdviceSourceChunk012.remaining) := by

import Zcash.Snark.ZeroKnowledge.ActionAdviceSourceChunks.Chunk004
...
private noncomputable def piece000 :
    SourceCertificatePiece (AdviceSourceCertificate (F := Fp)) (actionAdviceSourceChunk004.remaining) := by

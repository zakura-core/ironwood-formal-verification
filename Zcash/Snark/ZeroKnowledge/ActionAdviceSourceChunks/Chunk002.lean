import Zcash.Snark.ZeroKnowledge.ActionAdviceSourceChunks.Chunk001
...
private noncomputable def piece000 :
    SourceCertificatePiece (AdviceSourceCertificate (F := Fp)) (actionAdviceSourceChunk001.remaining) := by

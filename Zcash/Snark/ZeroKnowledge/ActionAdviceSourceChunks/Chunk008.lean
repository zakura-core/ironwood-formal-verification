import Zcash.Snark.ZeroKnowledge.ActionAdviceSourceChunks.Chunk007
...
private noncomputable def piece000 :
    SourceCertificatePiece (AdviceSourceCertificate (F := Fp)) (actionAdviceSourceChunk007.remaining) := by

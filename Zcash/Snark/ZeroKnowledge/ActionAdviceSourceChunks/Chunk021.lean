import Zcash.Snark.ZeroKnowledge.ActionAdviceSourceChunks.Chunk020
...
private noncomputable def piece000 :
    SourceCertificatePiece (AdviceSourceCertificate (F := Fp)) (actionAdviceSourceChunk020.remaining) := by

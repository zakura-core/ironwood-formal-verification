import Zcash.Snark.ZeroKnowledge.ActionAdviceSourceChunks.Chunk006
...
private noncomputable def piece000 :
    SourceCertificatePiece (AdviceSourceCertificate (F := Fp)) (actionAdviceSourceChunk006.remaining) := by

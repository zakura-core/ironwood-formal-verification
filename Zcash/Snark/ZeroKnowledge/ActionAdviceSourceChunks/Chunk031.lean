import Zcash.Snark.ZeroKnowledge.ActionAdviceSourceChunks.Chunk030
...
private noncomputable def piece000 :
    SourceCertificatePiece (AdviceSourceCertificate (F := Fp)) (actionAdviceSourceChunk030.remaining) := by

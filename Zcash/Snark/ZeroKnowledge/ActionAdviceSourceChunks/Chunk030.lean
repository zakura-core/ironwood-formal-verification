import Zcash.Snark.ZeroKnowledge.ActionAdviceSourceChunks.Chunk029
...
private noncomputable def piece000 :
    SourceCertificatePiece (AdviceSourceCertificate (F := Fp)) (actionAdviceSourceChunk029.remaining) := by

import Zcash.Snark.ZeroKnowledge.ActionAdviceSourceChunks.Chunk028
...
private noncomputable def piece000 :
    SourceCertificatePiece (AdviceSourceCertificate (F := Fp)) (actionAdviceSourceChunk028.remaining) := by

import Zcash.Snark.ZeroKnowledge.ActionAdviceSourceChunks.Chunk005
...
private noncomputable def piece000 :
    SourceCertificatePiece (AdviceSourceCertificate (F := Fp)) (actionAdviceSourceChunk005.remaining) := by

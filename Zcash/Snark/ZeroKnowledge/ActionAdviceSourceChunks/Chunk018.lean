import Zcash.Snark.ZeroKnowledge.ActionAdviceSourceChunks.Chunk017
...
private noncomputable def piece000 :
    SourceCertificatePiece (AdviceSourceCertificate (F := Fp)) (actionAdviceSourceChunk017.remaining) := by

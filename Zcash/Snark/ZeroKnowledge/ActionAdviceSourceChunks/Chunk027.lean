import Zcash.Snark.ZeroKnowledge.ActionAdviceSourceChunks.Chunk026
...
private noncomputable def piece000 :
    SourceCertificatePiece (AdviceSourceCertificate (F := Fp)) (actionAdviceSourceChunk026.remaining) := by

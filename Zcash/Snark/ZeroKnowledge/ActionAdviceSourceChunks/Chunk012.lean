import Zcash.Snark.ZeroKnowledge.ActionAdviceSourceChunks.Chunk011
...
private noncomputable def piece000 :
    SourceCertificatePiece (AdviceSourceCertificate (F := Fp)) (actionAdviceSourceChunk011.remaining) := by
